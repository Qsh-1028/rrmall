...
class Goods_EweiShopV2Page extends AppMobilePage
{
	...
	public function get_detail()
	{
		...
		$goods['canAddCart'] = 1;
		if ($goods['isverify'] == 2 || $goods['type'] == 2 || $goods['type'] == 3 || !empty($grftarray) || !empty($seckillinfo) || $goods['status'] == 2 || $goods['cannotrefund'] == 1) {
			$goods['canAddCart'] = 0;
		}
	...
	public function get_picker()
	{
		...
		$goods['canAddCart'] = 1;
		if ($goods['isverify'] == 2 || $goods['type'] == 2 || $goods['type'] == 3 || $goods['cannotrefund'] == 1) {
			$goods['canAddCart'] = 0;
		}
