...
class PluginMobilePage extends MobilePage
{
	...
	protected function view($template, $params = array())
	{
		...
		$defaultParams = array('basePath' => EWEI_SHOPV2_LOCAL . ('plugin/' . $plugin . '/static'), 'staticPath' => EWEI_SHOPV2_LOCAL . 'static/', 'appJsPath' => EWEI_SHOPV2_LOCAL . 'static/js/app', 'title' => 'qq960327091 淘宝：https://yscms.taobao.com');
